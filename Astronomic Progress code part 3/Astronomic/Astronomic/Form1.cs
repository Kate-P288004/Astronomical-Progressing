...
namespace Astronomic
{
...

    {
        ...
        private void InitializeLabels()
        {
            ...
            {
                AutoSize = true,
                Location = new System.Drawing.Point(30, 350), // Adjust location as needed
            ...
            {
                AutoSize = true,
                Location = new System.Drawing.Point(30, 370), // Adjust location as needed
                Name = "labelSuccessMessage",
                Size = new System.Drawing.Size(0, 13),
                ForeColor = System.Drawing.Color.Green // Set the text color to green
            };
    ...
    private void buttonSearch_Click(object sender, EventArgs e)
        ...
        if (int.TryParse(textBoxEditIndex.Text, out index) && int.TryParse(textBoxEditValue.Text, out newValue))
                ...
                // Display an error message if the index is out of range
                        labelErrorMessage.Text = "Index must be between 1 and 24."; // Display error if the index is out of range
                        labelSuccessMessage.Text = "";
                    }
                }
                else
                {
                    labelErrorMessage.Text = "Please enter valid integers."; // Display error if the inputs are not valid integers
                    labelSuccessMessage.Text = "";
                }
            }
